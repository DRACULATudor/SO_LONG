...
{
    if (j > 0 && arr[i][j - 1] != '1' && arr[i][j - 1] != 'T' && arr[i][j - 1] != 'B')
    {
...
{
    if (j < (win->width - 1) && arr[i][j + 1] != '1' && arr[i][j + 1] != 'T' && arr[i][j + 1] != 'B')
    {
        if (win->exit == false && arr[i][j + 1] != 'E')
        {
            arr[i][j] = '0';
...
{
    if (i > 0 && arr[i - 1][j] != '1' && arr[i - 1][j] != 'T' && arr[i - 1][j] != 'B')
    {
...
{
    if (arr[i + 1][j] != '1' && arr[i + 1][j] != 'T' && arr[i + 1][j] != 'B')
    {
        if (win->exit == false && arr[i + 1][j] != 'E')
        {
            arr[i][j] = '0';
