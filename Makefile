...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/04/24 15:09:30 by tlupu             #+#    #+#              #
#    Updated: 2024/04/24 17:07:48 by tlupu            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = so_long.c mandatory/game/game_disp_sprites.c mandatory/game/game_move_charact.c mandatory/game/rendering.c mandatory/helper/utils.c \
		...
		mandatory/helper/utils6.c mandatory/helper/utils7.c\
...
$(NAME): $(OBJS) $(MLX_DIR)/$(MLX_LIB) $(GNL_DIR)/$(GET_NEXT_LINE) $(PRNDR)/$(PRINTF)
	$(CC) $(CFLAGZ) -o $(NAME) $(OBJS) -L$(MLX_DIR) -L$(GNL_DIR) -l:$(GET_NEXT_LINE) -lmlx -L$(PRNDR) -l:$(PRINTF) -lXext -lX11 -lm

bonus: $(B_NAME)

$(B_NAME): $(OBJSBON) $(MLX_DIR)/$(MLX_LIB) $(GNL_DIR)/$(GET_NEXT_LINE)
	$(CC) $(CFLAGZ) -o $(B_NAME) $(OBJSBON) -L$(MLX_DIR) -lmlx -L$(GNL_DIR) -l:$(GET_NEXT_LINE) -L$(PRNDR) -l:$(PRINTF) -lXext -lX11 -lm
